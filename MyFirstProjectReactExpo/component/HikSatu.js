...
export default function HikSatu() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>Package 4 Channel</Text>
      <Image source={require('../component/hik/product.jpg')} style={styles.image} />
      <Text style={styles.paragraph}>
        Dua kamera Indoor dengan berbagai Spesifikasi dan berbagai pilihan.
      </Text>
      <Image source={require('../component/hik/product1.jpg')} style={styles.image} />
      <Text style={styles.paragraph}>
        Dua Unit kamera Outdoor dengan berbagai Spesifikasi.
      </Text>
      <Image source={require('../component/hik/produc3.jpg')} style={styles.image} />
      <Text style={styles.paragraph}>
        Satu Unit DVR (Digital Video Recording) yang memiliki 4 Channel 
      </Text>
