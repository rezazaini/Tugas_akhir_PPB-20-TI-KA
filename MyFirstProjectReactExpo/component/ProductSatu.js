...
export default function ProductSatu({ navigation, route }) {
  ...
  const carouselImages = [
    {
      image: require('../component/hik/4.png'),
      route: 'HikSatu', 
    },
    {
      image: require('../component/hik/8.png'),
      route: 'HikDua', 
    },
    {
      image: require('../component/hik/16.png'),
      route: 'HikTiga', // Ganti dengan nama rute halaman detail yang diinginkan
    },
