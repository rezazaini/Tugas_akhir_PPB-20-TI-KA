...
export default function HikDua() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>Package 8 Channel</Text>
      <Image source={require('../component/hik/product.jpg')} style={styles.image} />
      <Text style={styles.paragraph}>
        Tiga kamera Indoor dengan berbagai Spesifikasi dan berbagai pilihan.
      </Text>
      <Image source={require('../component/hik/product1.jpg')} style={styles.image} />
      <Text style={styles.paragraph}>
        Tiga Unit kamera Outdoor dengan berbagai Spesifikasi.
      </Text>
      <Image source={require('../component/hik/product2.jpg')} style={styles.image} />
      <Text style={styles.paragraph}>
        Dua Unit kamera DOM dengan berbagai keunggulan, pilihan, dan spesifikasi.
      </Text>
      <Image source={require('../component/hik/produc3.jpg')} style={styles.image} />
      <Text style={styles.paragraph}>
        Satu Unit DVR (Digital Video Recording) yang memiliki 8 Channel 
      </Text>
